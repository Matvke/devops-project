...
resource "yandex_container_repository" "kittygram-database" {
  name = "${yandex_container_registry.my-registry.id}/kittygram-database"
}
...
resource "yandex_container_repository" "kittygram-gateway" {
  name = "${yandex_container_registry.my-registry.id}/kittygram-gateway"
}
